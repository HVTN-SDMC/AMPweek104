...
# output file names
CIR.csvFile_pool_trunc  <- "../data/amp_cir_pool_postwk80_trunc.csv"
CIR.csvFile_ind_trunc   <- "../data/amp_cir_ind_postwk80_trunc.csv"
CIR.csvFile_summary <- "../data/amp_cir_efficacy_postwk80_trunc.csv"
