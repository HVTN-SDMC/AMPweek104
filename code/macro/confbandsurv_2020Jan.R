...
##               confidence bands (Parzen et al) for the contrast in Nelson-Aalen based 
##               estimates of the survival curves between two treatment groups
##
##  Function Inputs:
## ---------------------------------------------------------------------------------------
##  time    = mimimum of censoring time and failure time
##  delta   = 0 if censored, 1 if event
##  Rx      = 1 or 2 (2 = vaccine, 1 = placebo)
##  N       = number of simulated Gaussian variates for computing simuntaneous bands
