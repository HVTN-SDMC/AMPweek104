...
# data files
dataFile704 = file.path(datDir, 'v704_survival_wk80_tau_neut.csv')
dataDX = file.path(datDir, 'amp_diagnosis_day.csv')
dataIDT704 = file.path(datDir, 'v704_infusion_dates.csv')
dataDBS1 = file.path(datDir, 'v704_DBS_case_control.csv')
dataDBS2 = file.path(datDir, 'v704_DBS_monitoring.csv')
dataDBS3 = file.path(datDir, 'v704_DBS_pilot.csv')
