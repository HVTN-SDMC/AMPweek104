...
# input file name
dataFile <- "/Volumes/trials/vaccine/p703/analysis/efficacy/adata/v703_survival.csv"

# output file names
cuminc.csvFile_pool <- "../data/v703_cuminc_wk104_pool.csv"
cuminc.csvFile_ind  <- "../data/v703_cuminc_wk104_ind.csv"
